...
1. Ask how they are doing today, by first name — one short sentence, warm, nothing else. Let them answer in full.
2. Then, without announcing it, ask ONE easy question about their current working life — the sort of thing two professionals say to each other before a meeting starts. Something like what they are working on at the moment, or the biggest challenge their team is dealing with right now${input.jobTitle ? `, kept loosely in the world of ${input.jobTitle}` : ""}. One sentence. Let them answer in full.
